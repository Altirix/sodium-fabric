...
public class CloudRenderer {
    ...
    private static final float CLOUD_START_OFFSET_TEXTURE = -1.0F;
    ...
    public static void renderCloudEastFace(BufferBuilder builder, float cloudX, float cloudY, float cloudZ, float k, float l, float r, float g, float b) {
        ...
        for(int cloudPositionInChunk = 0; cloudPositionInChunk < 8; ++cloudPositionInChunk) {
            ...
            builder.vertex(cloudX + cloudPositionInChunk + CLOUD_START_OFFSET - EPSILON, cloudY, cloudZ + CLOUD_WIDTH)
                    .texture((cloudX - CLOUD_START_OFFSET_TEXTURE + cloudPositionInChunk + TEXTURE_OTHER_OFFSET) * TEXTURE_OFFSET + k, (cloudZ + CLOUD_WIDTH) * TEXTURE_OFFSET + l)
                    .color(red, green, blue, 0.8F)
                    .normal(1.0F, 0.0F, 0.0F)
                    .next();
            ...
            builder.vertex(cloudX + cloudPositionInChunk + CLOUD_START_OFFSET - EPSILON, cloudY + CLOUD_HEIGHT, cloudZ)
                    .texture((cloudX - CLOUD_START_OFFSET_TEXTURE + cloudPositionInChunk + TEXTURE_OTHER_OFFSET) * TEXTURE_OFFSET + k, cloudZ * TEXTURE_OFFSET + l)
                    .color(red, green, blue, 0.8F)
                    .normal(1.0F, 0.0F, 0.0F)
                    .next();
    ...
    public static void renderCloudSingleEastFace(BufferBuilder builder, float cloudX, float cloudY, float cloudZ, float k, float l, float r, float g, float b) {
        float red = r * 0.9F;
        float green = g * 0.9F;
        float blue = b * 0.9F;

        builder.vertex(cloudX + CLOUD_START_OFFSET - EPSILON, cloudY, cloudZ + CLOUD_WIDTH)
                .texture((cloudX - CLOUD_START_OFFSET_TEXTURE + TEXTURE_OTHER_OFFSET) * TEXTURE_OFFSET + k, (cloudZ + CLOUD_WIDTH) * TEXTURE_OFFSET + l)
                .color(red, green, blue, 0.8F)
                .normal(1.0F, 0.0F, 0.0F)
                .next();
        ...
        builder.vertex(cloudX + CLOUD_START_OFFSET - EPSILON, cloudY + CLOUD_HEIGHT, cloudZ)
                .texture((cloudX - CLOUD_START_OFFSET_TEXTURE + TEXTURE_OTHER_OFFSET) * TEXTURE_OFFSET + k, cloudZ * TEXTURE_OFFSET + l)
                .color(red, green, blue, 0.8F)
                .normal(1.0F, 0.0F, 0.0F)
                .next();
    ...
    public static void renderCloudSouthFace(BufferBuilder builder, float cloudX, float cloudY, float cloudZ, float k, float l, float r, float g, float b) {
        ...
        for(int cloudPositionInChunk = 0; cloudPositionInChunk < 8; ++cloudPositionInChunk) {
            ...
            builder.vertex(cloudX, cloudY + CLOUD_HEIGHT, cloudZ + cloudPositionInChunk + CLOUD_START_OFFSET - EPSILON)
                    .texture(cloudX * TEXTURE_OFFSET + k, (cloudZ - CLOUD_START_OFFSET_TEXTURE + cloudPositionInChunk + TEXTURE_OTHER_OFFSET) * TEXTURE_OFFSET + l)
                    .color(red, green, blue, 0.8F)
                    .normal(0.0F, 0.0F, 1.0F)
                    .next();
            builder.vertex(cloudX + CLOUD_WIDTH, cloudY + CLOUD_HEIGHT, cloudZ + cloudPositionInChunk + CLOUD_START_OFFSET - EPSILON)
                    .texture((cloudX + CLOUD_WIDTH) * TEXTURE_OFFSET + k, (cloudZ - CLOUD_START_OFFSET_TEXTURE + cloudPositionInChunk + TEXTURE_OTHER_OFFSET) * TEXTURE_OFFSET + l)
                    .color(red, green, blue, 0.8F)
                    .normal(0.0F, 0.0F, 1.0F)
                    .next();
    ...
    public static void renderCloudSingleSouthFace(BufferBuilder builder, float cloudX, float cloudY, float cloudZ, float k, float l, float r, float g, float b) {
        float red = r * 0.8F;
        float green = g * 0.8F;
        float blue = b * 0.8F;

        builder.vertex(cloudX, cloudY + CLOUD_HEIGHT, cloudZ + CLOUD_START_OFFSET - EPSILON)
                .texture(cloudX * TEXTURE_OFFSET + k, (cloudZ - CLOUD_START_OFFSET_TEXTURE + TEXTURE_OTHER_OFFSET) * TEXTURE_OFFSET + l)
                .color(red, green, blue, 0.8F)
                .normal(0.0F, 0.0F, 1.0F)
                .next();
        builder.vertex(cloudX + CLOUD_WIDTH, cloudY + CLOUD_HEIGHT, cloudZ + CLOUD_START_OFFSET - EPSILON)
                .texture((cloudX + CLOUD_WIDTH) * TEXTURE_OFFSET + k, (cloudZ - CLOUD_START_OFFSET_TEXTURE + TEXTURE_OTHER_OFFSET) * TEXTURE_OFFSET + l)
                .color(red, green, blue, 0.8F)
                .normal(0.0F, 0.0F, 1.0F)
                .next();
